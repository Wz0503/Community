...
public class RedisTests {
    ...
    public void testSortedSets(){
        ...
        redisTemplate.opsForZSet().add(redisKey, "唐增", 80);
        redisTemplate.opsForZSet().add(redisKey, "bajie", 50);
        redisTemplate.opsForZSet().add(redisKey, "1wwd", 70);
    ...
    public void testTransactional(){
        Object obj = redisTemplate.execute(new SessionCallback() {
            ...
            public Object execute(RedisOperations redisOperations) throws DataAccessException {
                ...
                redisOperations.opsForSet().add(redisKey, "张山");
                redisOperations.opsForSet().add(redisKey, "里斯");
